...
import { executeQuery, testWorkflow, getQueryHistory, getQueryDetail, executeBatchQueries } from '../controllers/query.controller.js';
...
router.post('/test', apiLimiter, authenticateJWT, testWorkflow);
// Batch query execution
router.post('/batch', queryLimiter, authenticateApiKey, executeBatchQueries);
// Get query history
router.get('/history', authenticateJWT, getQueryHistory);
// Get detailed query log
router.get('/history/:queryId', authenticateJWT, getQueryDetail);
