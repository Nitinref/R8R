 ...
 * Memory Node Types
 */
export type MemoryNodeType = 'memory_retrieve' | 'memory_update' | 'memory_summarize';
/**
 * Memory Consolidation Status
 */
export type ConsolidationStatus = 'pending' | 'processing' | 'completed' | 'failed' | 'cancelled';
/**
 * Memory Analytics
 */
