  ...
  return (
    <main className="relative grid min-h-screen place-items-center text-white">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle at center, #ff0000, rgba(0,0,0,0) 60%)",
        }}
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-br from-red/10 via-transparent to-red-2/10"
        aria-hidden
      />
      <Card className="w-full max-w-sm border-white/10 bg-black/40 backdrop-blur text-white">
        ...
        <CardContent className="space-y-4 text-white">
          ...
          <Button
            className="w-full bg-red hover:bg-red-2 text-white"
            disabled={loading}
          ...
          <p className="text-center text-sm opacity-90 text-white">
            No account?{" "}
            <Link className="underline hover:opacity-100 text-white" href="/auth/sign-up">
              Sign up
            </Link>
          </p>
        </CardContent>
