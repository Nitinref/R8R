...
text
    ...
    .glow-1 {
      width: 600px;
      height: 600px;
      background: radial-gradient(circle, #1e40af, transparent 60%);
  ...
  <ProtectedLayout>
    <main className="relative min-h-screen overflow-hidden text-[var(--brand-contrast)] bg-[var(--brand-bg)] grid-pattern">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle at center, #3b82f6, rgba(0,0,0,0) 75%)",
        }}
        aria-hidden
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex gap-3">
              <Link
                href="/workflows/new"
                className="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-3 font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/30"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="group relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-blue-500 rounded-2xl blur opacity-30 group-hover:opacity-50 transition-opacity duration-300"></div>
            <div className="relative bg-black/40 border border-white/10 rounded-2xl p-6 backdrop-blur-sm hover:border-blue-400/30 transition-all duration-300 group-hover:scale-105">
              <div className="flex items-center justify-between mb-4">
                <WorkflowIcon className="h-8 w-8 text-blue-400" />
                <Sparkles className="h-5 w-5 text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-black/40 border border-white/10 rounded-2xl p-6 backdrop-blur-sm hover:border-blue-400/30 transition-all duration-300 group-hover:scale-105">
              <div className="flex items-center justify-between mb-4">
                ...
                <TrendingUp className="h-5 w-5 text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          {/* Workflows Section */}
          <div className="group relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-blue-500 rounded-3xl blur opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link
            href="/editor"
            className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-blue-600/10 to-blue-500/10 p-6 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:border-blue-400/30"
          >
            <div className="flex items-center gap-4">
              <div className="h-12 w-12 bg-gradient-to-r from-blue-600 to-blue-500 rounded-xl flex items-center justify-center">
